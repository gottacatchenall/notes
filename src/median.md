The **median** is the value of a [distribution](distribution.md) $x$ defined such that the [cumulative density function](cdf.md) for that distribution has the property that $F(x) = 0.5$.
